...
void SMEWebBrowser::Construct(const FArguments& InArgs, const TSharedPtr<IWebBrowserWindow>& BrowserWindow)
{
	...
	ChildSlot
		...
		.Visibility(this, &SMEWebBrowser::GetViewportVisibility)
...
//void SMEWebBrowser::Tick(const FGeometry& AllottedGeometry, const double InCurrentTime, const float InDeltaTime)
//{
...
//EVisibility SMEWebBrowser::GetViewportVisibility() const
//{
...
//}
//
//bool SMEWebBrowser::HandleBeforePopup(FString URL, FString Frame)
//{
...
//}
//
//bool SMEWebBrowser::HandleSuppressContextMenu()
//{
//	return true;
//}
//
//bool SMEWebBrowser::HandleCreateWindow(const TWeakPtr<IWebBrowserWindow>& NewBrowserWindow, const TWeakPtr<IWebBrowserPopupFeatures>& PopupFeatures)
//{
//#if UE_BUILD_DEVELOPMENT || UE_BUILD_DEBUG
...
//		.OnCreateWindow(this, &SMeWebBrowser::HandleCreateWindow)
//		.OnCloseWindow(this, &SMeWebBrowser::HandleCloseWindow)
//		]);
//
//	{
//		struct FLocal
...
//}
//
//bool SMEWebBrowser::HandleCloseWindow(const TWeakPtr<IWebBrowserWindow>& BrowserWindowPtr)
//{
//#if UE_BUILD_DEVELOPMENT || UE_BUILD_DEBUG
...
//}
//
//bool SMEWebBrowser::HasMouseTransparency() const
//{
//	return bMouseTransparency && !bVirtualPointerTransparency;
//}
//
//bool SMEWebBrowser::HasVirtualPointerTransparency() const
//{
//	return bVirtualPointerTransparency;
//}
//
//float SMEWebBrowser::GetTransparencyDelay() const
//{
//	return TransparencyDelay;
//}
//
//float SMEWebBrowser::GetTransparencyThreshold() const
//{
//	return TransparencyThreadshold;
//}
//
//int32 SMEWebBrowser::GetTextureWidth() const
//{
//	if (!BrowserWindow.IsValid())
//		return 0;
//
...
//}
//
//int32 SMEWebBrowser::GetTextureHeight() const
//{
//	if (!BrowserWindow.IsValid())
//		return 0;
//
...
//}
//
//FColor SMEWebBrowser::ReadTexturePixel(int32 X, int32 Y) const
//{
...
//}
//
//TArray<FColor> SMEWebBrowser::ReadTexturePixels(int32 X, int32 Y, int32 Width, int32 Height) const
//{
...
void SMEWebBrowser::LoadURL(FString NewURL)
{
...
void SMEWebBrowser::LoadString(FString Contents, FString DummyURL)
{
	if (BrowserView.IsValid())
		BrowserView->LoadString(Contents, DummyURL);
}

void SMEWebBrowser::Reload()
{
	if (BrowserView.IsValid())
		BrowserView->Reload();
}

void SMEWebBrowser::StopLoad()
{
	if (BrowserView.IsValid())
		BrowserView->StopLoad();
}

FText SMEWebBrowser::GetTitleText() const
{
	if (BrowserView.IsValid())
	{
...
FString SMEWebBrowser::GetUrl() const
{
	if (BrowserView.IsValid())
...
FText SMEWebBrowser::GetAddressBarUrlText() const
{
	if (BrowserView.IsValid())
	{
...
bool SMEWebBrowser::IsLoaded() const
{
	if (BrowserView.IsValid())
...
bool SMEWebBrowser::IsLoading() const
{
	if (BrowserView.IsValid())
...
//bool SMEWebBrowser::CanGoBack() const
//{
//	if (BrowserView.IsValid())
//	{
...
//}
//
//FReply SMEWebBrowser::OnBackClicked()
//{
//	GoBack();
//	return FReply::Handled();
//}
//
//bool SMEWebBrowser::CanGoForward() const
//{
//	if (BrowserView.IsValid())
//	{
...
//}
//
//FReply SMEWebBrowser::OnForwardClicked()
//{
//	GoForward();
//	return FReply::Handled();
//}

FText SMEWebBrowser::GetReloadButtonText() const
{
...
FReply SMEWebBrowser::OnReloadClicked()
{
	if (IsLoading())
	{
		StopLoad();
...
void SMEWebBrowser::OnUrlTextCommitted(const FText& NewText, ETextCommit::Type CommitType)
{
...
EVisibility SMEWebBrowser::GetLoadingThrobberVisibility() const
{
	if (bShowInitialThrobber && !BrowserView->IsInitialized())
	{
		return EVisibility::Visible;
...
void SMEWebBrowser::ExecuteJavascript(const FString& ScriptText)
{
	if (BrowserView.IsValid())
		BrowserView->ExecuteJavascript(ScriptText);
}

void SMEWebBrowser::GetSource(TFunction<void(const FString&)> Callback) const
{
	if (BrowserView.IsValid())
	{
...
void SMEWebBrowser::BindUObject(const FString& Name, UObject* Object, bool bIsPermanent)
{
	if (BrowserView.IsValid())
		BrowserView->BindUObject(Name, Object, bIsPermanent);
}

void SMEWebBrowser::UnbindUObject(const FString& Name, UObject* Object, bool bIsPermanent)
{
	if (BrowserView.IsValid())
